...
| UX-10 | Редактирование приёма — bottom sheet (моб.)    | Высокий     | Средняя   | 📋 Запланировано               |
| UX-11 | Добавление позиции из дневника в каталог       | Высокий     | Средняя   | 📋 Запланировано               |
| UX-12 | «Рассчитать КБЖУ по всему дню»                 | Высокий     | Низкая    | 📋 Запланировано               |
...
| 26    | Tech Debt Sprint: срочные исправления          | Критический | Средняя   | 📋 Запланировано               |
| 27    | Наблюдаемость (pino, Sentry, /health, metrics) | Критический | Средняя   | 📋 Запланировано               |
| 28    | Безопасность: CSRF, MFA, EXIF, ClamAV          | Высокий     | Высокая   | 📋 Запланировано               |
| 29    | Рефакторинг: расщепление монолитов             | Высокий     | Высокая   | 📋 Запланировано               |
| 30    | Тестирование: расширение покрытия              | Высокий     | Высокая   | 📋 Запланировано               |
| 31    | UX-полировка: undo, skeleton, a11y, dark       | Высокий     | Средняя   | 📋 Запланировано               |
