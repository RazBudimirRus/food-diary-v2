...
**Версия:** 2.6.0  
**Дата обновления:** 5 июля 2026 (v2.20.0)  
...
> **Статус:** 🐛 Баг · требует исправления
> **Приоритет:** Средний
> **Воспроизводится:** всегда, когда пользователь вводит жидкость в поле «Что пил», не используя счётчик порций воды
> **Версия обнаружения:** v2.17.0
