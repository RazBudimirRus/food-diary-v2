...
**Статус:** 🚧 Частично реализовано в v1.7.0 — foundation: роли, `requireAdmin`, bootstrap admin и read-only список активных refresh sessions. Остались reset password, revoke sessions и DeepSeek dashboard.
...
| 4    | Административная панель             | Средний     | Высокая   | 🚧 Частично: foundation v1.7.0 |
...
**Следующий шаг после v1.7.0:** Фаза 4 slice 2 — управление сессиями: revoke конкретной сессии / revoke всех сессий пользователя.
