...
<nav className="fixed bottom-0 left-0 right-0 z-20 flex sm:hidden
...
|---|---|---|---|
| 14.1 | Компактный header — кнопки иконки, меню | Низкая | 🔴 Высокий |
| 14.2 | Форма — one-column на мобильных, крупные tap targets | Низкая | 🔴 Высокий |
| 14.3 | Bottom navigation bar (hidden на desktop) | Средняя | 🔴 Высокий |
| 14.4 | Крупнее кнопки на карточках приёмов | Низкая | 🟡 Средний |
| 14.5 | ResponsiveContainer на всех графиках | Низкая | 🟡 Средний |
| 14.6 | PWA install prompt + iOS Safari подсказка | Средняя | 🟡 Средний |
