...
| UX-2 | Логин пользователя в админке        | Высокий     | Низкая    | 📋 Запланировано        |
| UX-3 | Перенос приёма между днями          | Высокий     | Средняя   | 📋 Запланировано        |
| UX-4 | Явные даты подъёма и отбоя          | Высокий     | Средняя   | 📋 Запланировано        |
| UX-5 | Календарные периоды аналитики       | Средний     | Средняя   | 📋 Запланировано        |
...
**Следующий шаг после v1.12.0:** UX-2 → UX-3 → UX-4 → UX-5, затем Фаза 7 — WAF и инфраструктура.
