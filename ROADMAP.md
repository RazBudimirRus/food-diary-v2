...
| UX-14 | Дата нового приёма = выбранный день            | Высокий     | Низкая    | 📋 Запланировано                                                                                      |
| UX-15 | Форма добавления приёма вверху страницы        | Высокий     | Средняя   | 📋 Запланировано                                                                                      |
| UX-16 | Фото в форме создания приёма                   | Высокий     | Низкая    | 📋 Запланировано                                                                                      |
