          ...
          <>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Загружает реальный WebP-файл через тот же pipeline что и фото пользователей: sharp → PutObject →
                            ...
                            {s3Stats.byUser.map((row) => (
                              <TableRow key={row.userId ?? "other"}>
                                ...
                                <TableCell className="text-xs text-right">
                                  {(row.totalBytes / 1024).toFixed(1)} КБ
                                </TableCell>
                              </TableRow>
                            ))}
                          </TableBody>
