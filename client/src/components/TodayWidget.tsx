 ...
 */
import { Flame, Utensils, Footprints, TrendingUp } from "lucide-react";
...
export function TodayWidget({ mealsCount, totalKcal, totalWater, steps, hasKcal }: TodayWidgetProps) {
  ...
  return (
    <div
      className="flex items-center gap-2 flex-wrap bg-gradient-to-r from-primary/8 to-transparent
